/**
 ********************************************************************
 * @file    ziyan_hms_info_table.h
 * @brief   This is the header file for "ziyan_hms_info_table.c", defining the structure and
...
#ifndef ZIYAN_HMS_INFO_TABLE_H
#define ZIYAN_HMS_INFO_TABLE_H
...
const T_ZiyanHmsErrCodeInfo hmsErrCodeInfoTbl[] = {
    ...
    {0x16100002, "ZIYAN Assistant connected. Unable to take off. Disconnect before taking off",                                                             "ZIYAN Assistant connected. Disconnect before taking off"},
    ...
    {0x1610000b, "Battery cell error. Unable to take off. Contact ZIYAN Support",                                                                           "Battery cell error. Return to home or land"},
    ...
    {0x16100016, "Aircraft not activated. Unable to take off. Restart ZIYAN Pilot and activate aircraft",                                                   "Aircraft not activated. Restart ZIYAN Pilot and activate aircraft"},
    ...
    {0x16100019, "ESC error. Unable to take off. Contact ZIYAN Support",                                                                                    "ESC error. Land immediately"},
    ...
    {0x16100029, "Invalid aircraft serial number. Unable to take off. Contact your local dealer or ZIYAN Support",                                          "Invalid aircraft serial number. Return to home or land"},
    ...
    {0x16100030, "Aircraft model and firmware version do not match. Unable to take off. Contact your local dealer or ZIYAN Support.",                       "Aircraft model and firmware version do not match. Return to home or land"},
    ...
    {0x1610004f, "Battery authentication failed. Unable to take off. Replace with ZIYAN battery",                                                           "Battery authentication failed. Replace with standard ZIYAN battery"},
    ...
    {0x16100054, "Gimbal error. Unable to take off. Contact ZIYAN Support",                                                                                 "Gimbal error. Return to home or land"},
    {0x16100055, "Gimbal error. Unable to take off. Contact ZIYAN Support",                                                                                 "Gimbal error. Return to home or land"},
    {0x16100056, "Gimbal error. Unable to take off. Contact ZIYAN Support",                                                                                 "Gimbal error. Return to home or land"},
    {0x16100057, "Gimbal error. Unable to take off. Contact ZIYAN Support",                                                                                 "Gimbal error. Return to home or land"},
    ...
    {0x16100076, "IMU error. Unable to take off. Contact ZIYAN Support",                                                                                    "IMU error. Return to home or land"},
    {0x16100078, "Compass error. Unable to take off. Contact ZIYAN Support",                                                                                "Compass error. Return to home or land"},
    ...
    {0x161000c8, "Unable to take off. Check whether aircraft is connected to ZIYAN Assistant or system is updating",                                        "Check whether aircraft is connected to ZIYAN Assistant or system is updating"},
    {0x161000c9, "Unable to take off. Check whether aircraft is connected to ZIYAN Assistant or system is updating",                                        "Check whether aircraft is connected to ZIYAN Assistant or system is updating"},
    ...
    {0x16000002, "Flight data record abnorma.If the warning persists, contact your local dealer or ZIYAN Support.",                                         "Flight data record abnorma.If the warning persists, contact your local dealer or ZIYAN Support."},
    ...
    {0x110b0006, "Battery %index cell damaged. Stop using this battery and contact ZIYAN Support",                                                          ""},
    ...
    {0x110b0007, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b0008, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b0009, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b000a, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b000b, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b000c, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    {0x110b000d, "Battery %index damaged. Stop using this battery and contact ZIYAN Support",                                                               ""},
    ...
    {0x1b010802, "ZIYAN Pilot error. Smart Track paused. Restart ZIYAN Pilot",                                                                                ""},
    {0x1b010803, "ZIYAN Pilot error. Smart Track paused. Restart ZIYAN Pilot",                                                                                ""},

...
static T_ZiyanWidgetFileBinaryArray s_EnWidgetFileBinaryArrayList[] = {
...
/* Export values -------------------------------------------------------------*/
uint32_t g_EnBinaryArrayCount = sizeof(s_EnWidgetFileBinaryArrayList) / sizeof(T_ZiyanWidgetFileBinaryArray);
T_ZiyanWidgetFileBinaryArray * g_EnFileBinaryArrayList = s_EnWidgetFileBinaryArrayList;
